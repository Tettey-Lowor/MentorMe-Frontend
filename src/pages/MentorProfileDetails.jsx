            ...
            <div class="col-span-4 sm:col-span-3">
                <div class="bg-white shadow rounded-lg p-6">
                    <div class="flex flex-col items-center">
                        <img src={image1} class="w-32 h-32 bg-gray-300 rounded-full mb-4 shrink-0">
                        ...
                        <div class="mt-6 flex flex-wrap gap-4 justify-center">
                            ...
                            <Link to='/BookAppointmentPage' class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Book Now</Link> 
                        </div>
                    </div>
                ...
                <div class="bg-white shadow rounded-lg p-6">
                    ...
                    <div class="mb-6">
                        <div class="flex justify-between flex-wrap gap-2 w-full">
                            ...
                            <p>
                                <span class="text-gray-700 mr-2">at Drupal Company</span>
                    ...
                    <div class="mb-6">
                        <div class="flex justify-between flex-wrap gap-2 w-full">
                            <span class="text-gray-700 font-bold">Web Developer</span>
                            <p>
                                <span class="text-gray-700 mr-2">at Microsoft</span>
                                <span class="text-gray-700">2017 - 2019</span>
                            </p>
                        </div>
                        <p class="mt-2">
