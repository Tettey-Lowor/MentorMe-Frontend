...
export default function CVSample() {
  return (
    // <!-- component -->
<>
<Navbar/>
<body class="bg-gray-100 text-white">
    <div class="container mx-auto py-10 px-5">
        <div class="max-w-4xl mx-auto bg-gray-900 rounded-lg shadow-md overflow-hidden">
            <div class="p-4 sm:p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-2xl font-semibold">John Doe</h2>
                        <p class="text-sm text-white">Senior Software Engineer</p>
                    </div>
                    <div>
                        <p class="text-sm text-white">Phone: (123) 456-7890</p>
                        <p class="text-sm text-white">Email: john.doe@example.com</p>
                        <p class="text-sm text-white">Location: San Francisco, CA</p>
                    </div>
                </div>
                <hr class="my-4"/>
                <div>
